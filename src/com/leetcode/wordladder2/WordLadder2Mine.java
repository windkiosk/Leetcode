...
//        hashSet.add("dog");
        ...
        List<List<String>> result = wordLadder.findLadders("sand", "acne", hashSet);

        System.out.println(System.currentTimeMillis() - time + ", " + result.size());
